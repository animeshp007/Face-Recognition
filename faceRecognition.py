...
def faceDetection(test_img):
    ...
    face_haar_cascade=cv2.CascadeClassifier(r'C:\Users\Mohit\PycharmProjects\Myproject\venv\HaarCascade\haarcascade_frontalface_default.xml')#Load haar classifier
